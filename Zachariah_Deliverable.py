def bluff_dealer(hand_played):
    """Handles giving pile to losing player and will give cards in hand that 
    was played and rest of card pile. 
    Args:
        hand_played(list): hand that was played when bluff was called"""
    pass

def checking_bluff(p1_name,p1_hand,p2_hand,p2_cards_played,req_value):
